...
<script type="text/javascript">
	...
	nextURL = 'orig_02_waves_hearts_applique_king.php';
...
<!-- Up button -->
<td> <a href="01_bargello_symphony_queen.php"><img src="../res/dark_grey/up.gif" border=0 ALT=" Close   
Up one level "></a> </td>
<!-- Previous button -->
<td> <a href="orig_13_log_cabin_lone_star.php"><img src="../res/dark_grey/previous_disabled.gif" alt="Last Page" border=0></a> </td>
<!-- Play/paues button -->
<td> <a href="javascript:playpause()"><img src="../res/dark_grey/pause.gif" name="playpause" ALT="Slide Show" border=0></a> </td>
<!-- Next button -->
<td> <a href="orig_02_waves_hearts_applique_king.php"><img src="../res/dark_grey/next.gif" alt="Next page" border=0></a> </td>
</tr></table></div>

<!-- Image with link to original -->
<table width="100%" height="100%" cellspacing=0 cellpadding=0><tr><td align="center"><a href="orig2_01_bargello_symphony_queen.php"><script type="text/javascript">
setVal();
sizeImg(800, 600);
document.write('<img src="../01_bargello_symphony_queen.jpg" width="' + tWidth + '" height="' + tHeight + '" border=0 alt="   01_bargello_symphony_queen  + ">');
