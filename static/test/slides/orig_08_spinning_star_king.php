...
<script type="text/javascript">
	...
	nextURL = 'orig_09_bargello_wave.php';
...
<!-- Up button -->
<td> <a href="08_spinning_star_king.php"><img src="../res/dark_grey/up.gif" border=0 ALT=" Close   
Up one level "></a> </td>
<!-- Previous button -->
<td> <a href="orig_07_bargello_heart.php"><img src="../res/dark_grey/previous.gif" alt="Previous page" border=0></a></a> </td>
<!-- Play/paues button -->
<td> <a href="javascript:playpause()"><img src="../res/dark_grey/pause.gif" name="playpause" ALT="Slide Show" border=0></a> </td>
<!-- Next button -->
<td> <a href="orig_09_bargello_wave.php"><img src="../res/dark_grey/next.gif" alt="Next page" border=0></a> </td>
</tr></table></div>

<!-- Image with link to original -->
<table width="100%" height="100%" cellspacing=0 cellpadding=0><tr><td align="center"><a href="orig2_08_spinning_star_king.php"><script type="text/javascript">
setVal();
sizeImg(800, 600);
document.write('<img src="../08_spinning_star_king.jpg" width="' + tWidth + '" height="' + tHeight + '" border=0 alt="   08_spinning_star_king  + ">');
