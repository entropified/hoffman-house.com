...
<script type="text/javascript">
	...
	nextURL = 'orig_13_log_cabin_lone_star.php';
...
<!-- Up button -->
<td> <a href="12_log_cabin_yellow_blue.php"><img src="../res/dark_grey/up.gif" border=0 ALT=" Close   
Up one level "></a> </td>
<!-- Previous button -->
<td> <a href="orig_10_scrapaholic.php"><img src="../res/dark_grey/previous.gif" alt="Previous page" border=0></a></a> </td>
<!-- Play/paues button -->
<td> <a href="javascript:playpause()"><img src="../res/dark_grey/pause.gif" name="playpause" ALT="Slide Show" border=0></a> </td>
<!-- Next button -->
<td> <a href="orig_13_log_cabin_lone_star.php"><img src="../res/dark_grey/next.gif" alt="Next page" border=0></a> </td>
</tr></table></div>

<!-- Image with link to original -->
<table width="100%" height="100%" cellspacing=0 cellpadding=0><tr><td align="center"><a href="orig2_12_log_cabin_yellow_blue.php"><script type="text/javascript">
setVal();
sizeImg(800, 533);
document.write('<img src="../12_log_cabin_yellow_blue.jpg" width="' + tWidth + '" height="' + tHeight + '" border=0 alt="   12_log_cabin_yellow_blue  + ">');
